...
class Cache {
  ...
  constructor() {
    ...
    const option = { max: 100, ttl: 5 * 60 * 1000, ttlAutopurge: true };
...
function addCsrfToken(datasource: DatasourceResource): DatasourceResource;
function addCsrfToken(datasource: GlobalDatasourceResource): GlobalDatasourceResource;
function addCsrfToken(datasource: undefined): undefined;
function addCsrfToken(datasource: DatasourceResource | undefined): DatasourceResource | undefined;
function addCsrfToken(
  datasource: GlobalDatasourceResource | undefined,
): GlobalDatasourceResource | undefined;
function addCsrfToken(
  datasource: DatasourceResource | GlobalDatasourceResource | undefined,
): DatasourceResource | GlobalDatasourceResource | undefined {
  if (!datasource) {
    return datasource;
  }
